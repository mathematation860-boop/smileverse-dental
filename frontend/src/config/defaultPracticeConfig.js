...
const defaultPracticeConfig = {
  ...
  // Full list (including the two null-priced entries) so the booking
  // flow's reason picker — which is now built from this list, not a
  // separate hard-coded one — shows every category even in the brief
  // window before the real config has loaded.
  services: [
    { id: 'cleaning', name: 'Cleaning', price: 150, duration: 45 },
    { id: 'consultation', name: 'Consultation', price: 0, duration: 30 },
    ...
    { id: 'emergency', name: 'Emergency', price: null, duration: 30 },
    { id: 'other', name: 'Other', price: null, duration: 30 },
  ],
