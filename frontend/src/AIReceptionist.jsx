...
const AIReceptionist = () => {
  ...
  const [bookingForm, setBookingForm] = useState({ name: '', phone: '', service: 'Cleaning', date: '', time: '10:00 AM' });
  ...
  const bookAppointment = async () => {
    if (!bookingForm.name || !bookingForm.phone || !bookingForm.date) {
      alert('Please fill in your name, phone, and date / براہ کرم نام، فون اور تاریخ درج کریں');
      return;
    }
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <div>
            ...
            <p style={{ margin: '0', fontSize: '16px', opacity: 0.9 }}>AI Powered Reception System | Real Gemini API</p>
          </div>
          <div style={{
            padding: '12px 20px',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            {showBookingForm && (
              <div style={{ backgroundColor: '#e6f7ff', padding: '15px', borderRadius: '8px', border: '1px solid #91d5ff' }}>
                <input
                  type="text"
                ...
                <select
                  ...
                  style={{ width: '100%', padding: '8px', marginBottom: '8px', borderRadius: '4px', border: '1px solid #d1d5db', boxSizing: 'border-box' }}
                >
                  <option value="Cleaning">Cleaning - $150</option>
                  <option value="Root Canal">Root Canal - $800</option>
                  <option value="Whitening">Whitening - $200</option>
                  <option value="Filling">Filling - $250</option>
                  <option value="Extraction">Extraction - $300</option>
                  <option value="Crown">Crown - $1200</option>
                </select>
                <input
                  type="date"
        ...
        <div style={{ marginTop: '30px', padding: '20px', backgroundColor: '#f3f4f6', borderRadius: '10px', textAlign: 'center', color: '#6b7280', fontSize: '14px' }}>
          <p style={{ margin: '0' }}>🤖 Powered by Google Gemini | 24/7 Support Available</p>
